            ...
            <div class="container-Profi">
                ...
                <div class="profile">
                    <div class="profile-image">
                        <img src="/imgs/images/pdp.jpg"
                            alt="" style={{ width: '140px' }} />
                    </div>
                    <div class="profile-user-settings">
                        <h1 class="profile-user-name">Hamza Bannour</h1>
                        <button class="primary profile-edit-btn" >Follow</button>
                    ...
                    <div class="profile-bio">
                        <p><span class="profile-real-name">Jane Doe</span> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Adipisci rerum quis distinctio modi omnis, soluta iste dolor enim dicta quisquam illo maxime repellendus. 📷✈️🏕️</p>
                    </div>
                </div>
